  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#180B3A] via-[#2E0E73] to-[#0C0E2B] text-white flex flex-col items-center p-4 sm:p-6">
      ...
      {view === "demo" && (
        ...
        >
          <Button className="mb-4 bg-[#3B257A] text-white text-sm" onClick={goBack}>
            <ArrowLeft className="w-4 h-4 mr-2" /> Back
          </Button>
          <h2 className="text-lg sm:text-xl font-semibold mb-2">
            KIUT – AI Concierge Demo
          </h2>
          <p className="text-sm text-gray-300 mb-4">
            Watch how our AI bot handles real-time customer interactions and
            sales assistance.
          </p>
      ...
      {view === "about" && (
        ...
        >
          ...
          <h2 className="text-lg sm:text-xl font-semibold mb-2">
            About KIU System Solutions
          </h2>
          <p className="text-sm text-gray-300 mb-3 italic">
            Empowering aviation with intelligent technology
          </p>
          <p className="text-sm text-gray-300 mb-4">
            KIU provides integrated technological solutions for the aviation and
            travel industries, offering PSS, GDS, e-commerce, and management tools
            tailored for airlines, travel agencies, and tourism companies
            worldwide.
          </p>
          <ul className="list-disc list-inside text-sm text-gray-300 space-y-1">
            <li>
              <strong>KIU GDS / Multi-hosting:</strong> Airline content
              distribution to 45,000+ agencies in 80+ countries.
            </li>
            <li>
              <strong>KIUT (AI Concierge):</strong> Conversational AI for sales
              and customer service across digital channels.
            </li>
            <li>
              <strong>Post-Booking RMS:</strong> Revenue management and
              optimization tools.
            </li>
            <li>
              <strong>E-commerce & Cargo Solutions:</strong> Streamlining airline
              sales and logistics.
            </li>
            <li>
              <strong>Analytics & BI:</strong> Business intelligence for smarter
              decision-making.
            </li>
          </ul>
  ...
  <p className="text-[10px] text-gray-500 text-center">
    ...
    <span className="text-gray-300">amaidana@kiusys.com</span>
            ...
            <div className="text-center bg-[#14103A] rounded-2xl p-6 ring-1 ring-white/10">
              ...
              <p className="text-sm text-gray-300 mb-4">
                Your details have been received. Our team will get back to you
                soon.
              </p>
              <a
                href="/Alejandro_Maidana.vcf"
